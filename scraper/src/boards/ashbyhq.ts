...
export async function run(db: BetterSQLite3Database, mainLog: L.Log, sampler: A.Sampler) {
    ...
    while(true) {
        ...
        const toCheck = C.getCompaniesToCheck(db, Company, [...companiesInProcess], { weights: [0.5, 0.1] })
